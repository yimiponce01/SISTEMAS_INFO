...
export default function Sidebar({ open, currentView, setCurrentView, darkMode, userRole}: SidebarProps) {
  const allMenuItems: {
    id: string;
    label: string;
    icon: any;
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`fixed left-0 top-16 bottom-0 w-64 z-50 transition-all duration-300 ${open ? 'translate-x-0' : '-translate-x-full'
