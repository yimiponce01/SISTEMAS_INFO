...
export default function FilterBar({
  ...
  const handleClearFilters = () => {
    ...
    setDateRange({ from: '2026-01-01', to: '2026-05-15' });
  };

  return (
    <div className={`mb-6 p-5 rounded-xl border transition-all hover:shadow-lg ${
      darkMode
      ...
      <div className="flex flex-wrap items-center gap-6">
        ...
        <div className="flex-1 min-w-[250px]">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 px-4 py-2.5 rounded-lg font-light transition-all transform hover:scale-105 ${
          ...
          <div className="flex items-center gap-3">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-2.5 rounded-lg border font-light ${
                  darkMode
        ...
        <div className="flex items-end">
          <button
            ...
            className={`px-4 py-2.5 rounded-lg font-light transition-all flex items-center gap-2 ${
              darkMode
                ? 'bg-slate-700 text-slate-300 hover:bg-slate-600'
                : 'bg-slate-100 text-slate-700 hover:bg-slate-200'
            }`}
